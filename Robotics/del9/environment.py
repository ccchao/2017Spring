...
class ENVIRONMENT:
    def __init__(self, i):
        ...
        #if self.ID == 0 :
        #    self.Place_Ball_To_One()
        if self.ID == 0:
            self.Place_Ball_To_Two()
        elif self.ID == 1:
            self.Place_Ball_To_Three()
        elif self.ID == 2:
            self.Place_Ball_To_Four()
    ...
    def Place_Ball_To_One(self):
        self.x = c.L*5
        self.y = c.L*5
        self.z = c.B+c.H

    def Place_Ball_To_Two(self):
        self.x = c.L*5
        self.y = -c.L*5
        self.z = c.B+c.H

    def Place_Ball_To_Three(self):
        self.x = -c.L*5
        self.y = -c.L*5
        self.z = c.B+c.H

    def Place_Ball_To_Four(self):
        self.x = -c.L*5
        self.y = c.L*5
        self.z = c.B+c.H
    ...
    def Send_Joints(self, sim):
        ...
        sim.Send_Joint(jointID=13, firstObjectID=6, secondObjectID=-1) 
