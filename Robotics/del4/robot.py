...
class ROBOT:
    ...
    def Send_Joints(self,sim):
        ...
        #sim.Send_Joint(jointID=4, firstObjectID=0, secondObjectID=5, x=0, y=c.L/2, z=c.L/2+c.W+c.H, lo=0, hi=0) #pole
        sim.Send_Joint(jointID=4, firstObjectID=0, secondObjectID=5, x=0, y=c.L/2, z=c.W*2+c.H, lo=0, hi=0) #pole
    ...
    def Send_Neurons(self,sim):
        ...
        sim.Send_Motor_Neuron(neuronID=5, jointID=0, tau=0.1)
        sim.Send_Motor_Neuron(neuronID=6, jointID=1, tau=0.1)
