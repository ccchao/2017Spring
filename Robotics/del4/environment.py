...
class ENVIRONMENT:
    ...
    def Send_Objects(self, sim):
        ...
        sim.Send_Cylinder(objectID=13, x=self.x, y=self.y, z=self.z, length=0, radius=c.B, r=1, g=1, b=1) #front right ball
    ...
    def Send_Joints(self, sim):
        sim.Send_Joint(jointID=6, firstObjectID=7, secondObjectID=6, x=c.S/2, y=0, z=c.H/2, lo=0, hi=0) #right
        sim.Send_Joint(jointID=7, firstObjectID=8, secondObjectID=6, x=-c.S/2, y=0, z=c.H/2, lo=0, hi=0) #left
        
        sim.Send_Joint(jointID=8, firstObjectID=9, secondObjectID=6, x=0, y=c.S/2+c.H, z=c.H, lo=0, hi=0) #up outside
        sim.Send_Joint(jointID=9, firstObjectID=10, secondObjectID=7, x=c.S/2+c.H, y=0, z=c.H, lo=0, hi=0) #right outside
        sim.Send_Joint(jointID=10, firstObjectID=11, secondObjectID=6, x=0, y=-c.S/2-c.H, z=c.H, lo=0, hi=0) #down outside
        sim.Send_Joint(jointID=11, firstObjectID=12, secondObjectID=8, x=-c.S/2-c.H, y=0, z=c.H, lo=0, hi=0) #left outside
        
        sim.Send_Joint(jointID=12, firstObjectID=9, secondObjectID=10, x=c.S/2+c.H*1.5, y=c.S/2+c.H*1.5, z=c.H, lo=0, hi=0) #up-right outside
        sim.Send_Joint(jointID=13, firstObjectID=10, secondObjectID=11, x=c.S/2+c.H*1.5, y=-c.S/2-c.H*1.5, z=c.H, lo=0, hi=0) #down-right outside
        sim.Send_Joint(jointID=14, firstObjectID=11, secondObjectID=12, x=-c.S/2-c.H*1.5, y=-c.S/2-c.H*1.5, z=c.H, lo=0, hi=0) #down-left outside
        sim.Send_Joint(jointID=15, firstObjectID=12, secondObjectID=9, x=-c.S/2-c.H*1.5, y=c.S/2+c.H*1.5, z=c.H, lo=0, hi=0) #up-left outside
