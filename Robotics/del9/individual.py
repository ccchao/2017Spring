...
class INDIVIDUAL:
    ...
    def Compute_Fitness(self, env):
        ...
        if env == 0:
            ...
            self.fitness = self.fitness + max(x)
        ...
        self.fitness = self.fitness + max(x)*10 + m*30

            
        print self.ID, 'm=', m, 'shoot/y=', max(x), 'fit=', self.fitness,
        
      
        y = self.sim.Get_Sensor_Data(sensorID=9) #second ball -> first ball/Users/chun/Desktop/RESUME_ChiaChun_Chao.docx
