...
class ROBOT:
    ...
    def Send_Joints(self,sim):
        sim.Send_Joint(jointID=0, firstObjectID=0, secondObjectID=1, x=c.L/2, y=c.L/2, z=c.W+c.H, n1=1, n2=0, n3=0, lo=-3.14159, hi=3.14159*2, positionControl=False) #front right wheel
        sim.Send_Joint(jointID=1, firstObjectID=0, secondObjectID=2, x=-c.L/2, y=c.L/2, z=c.W+c.H, n1=1, n2=0, n3=0, lo=-3.14159, hi=3.14159*2, positionControl=False) #front left wheel
        sim.Send_Joint(jointID=0, firstObjectID=0, secondObjectID=3, x=c.L/2, y=-c.L/2, z=c.W+c.H, n1=1, n2=0, n3=0, lo=-3.14159, hi=3.14159*2, positionControl=False) #rear right wheel
        sim.Send_Joint(jointID=1, firstObjectID=0, secondObjectID=4, x=-c.L/2, y=-c.L/2, z=c.W+c.H, n1=1, n2=0, n3=0, lo=-3.14159, hi=3.14159*2, positionControl=False) #rear left wheel
    ...
    def Send_Neurons(self,sim):
        ...
        sim.Send_Motor_Neuron(neuronID=5, jointID=0, tau=0.07)
        sim.Send_Motor_Neuron(neuronID=6, jointID=1, tau=0.07)
